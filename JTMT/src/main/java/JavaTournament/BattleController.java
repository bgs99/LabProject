...
class BattlePanel extends JPanel {
    ...
    private void updateFighters(Map<LogId, FighterStats> team) {
        ...
        if(team == fightersA) {
            ...
            jLabel4.setText("Speed: " + curA.speed);
            jLabel5.setText("Attack: " + curA.attack);
            jLabel6.setText("S. Attack: " + curA.s_attack);
            //TODO: S. Defence
            ...
            jLabel8.setText("Speed: " + curB.speed);
            jLabel9.setText("Attack: " + curB.attack);
            jLabel10.setText("S. Attack: " + curB.s_attack);
        }
    }
}