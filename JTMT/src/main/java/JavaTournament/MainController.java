...
public class MainController {
    ...
    private final int LOGINPAGE_HEIGHT = 250;
    private final int LOGINPAGE_WIDTH = 250;
    ...
    MainController(JFrame frame) {
        ...
        frame.setPreferredSize(new Dimension(LOGINPAGE_HEIGHT, LOGINPAGE_WIDTH));
        Dimension screenSize = new Dimension(screenWidth, screenHeight);
        System.out.println(screenSize);
        Point middle = new Point(screenSize.width / 2, screenSize.height / 2);
        System.out.println("x = " + (middle.x - (LOGINPAGE_WIDTH / 2  )));
        System.out.println("y = " + (middle.y + (LOGINPAGE_HEIGHT/2 )));
